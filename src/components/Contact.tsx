...
export default function Contact() {
  ...
  if (status === "success") {
    return (
      <section id="contacto" className="bg-bone-50 py-8 lg:py-10">
          ...
          <div className="bg-pastel-50 rounded-3xl px-6 sm:px-10 lg:px-14 py-14 lg:py-20">
            <div className="mx-auto max-w-2xl text-center">
              ...
              <p className="mt-4 text-navy-700 leading-relaxed">
                ...
                and will get back to you shortly, usually within one
                business day.
              </p>
              <button
                type="button"
                onClick={() => setStatus("idle")}
                className="mt-8 inline-flex items-center gap-2 border border-navy-900/20 hover:border-navy-900 bg-white text-navy-900 font-semibold px-6 py-3 rounded-full transition-colors"
              >
          ...
          <div className="mx-auto max-w-3xl">
            <div className="text-center mb-14">
              ...
              <p className="mt-5 text-navy-700 max-w-lg mx-auto leading-relaxed">
                Tell us about your project and attach plans or photos —
            ...
            <form
              ...
              className="bg-white rounded-3xl p-8 lg:p-12 space-y-6 shadow-sm"
            >
              <input
                type="text"
